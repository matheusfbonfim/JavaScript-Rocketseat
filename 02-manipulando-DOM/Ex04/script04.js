...
// Chamada da função para adicionar nomes na lista
adicionarNomes();
...
function adicionar(){
  ...
  // Acrescenta no vetor nomes o input.value
  nomes.push(inputName.value);

  let lista = document.querySelector("#itens");
  
  // Exclui todos os nomes presentes no HTML
  while (lista.firstChild) {
    lista.removeChild(lista.firstChild);
  } 

  // Adiciona todos os nomes, tendo agora o novo elemento
  adicionarNomes();
